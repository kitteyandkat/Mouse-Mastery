...
1	1	hint	0	0	To get started, locate the Phone app on your Android device...	Android
1	1	hint	0	0	Welcome to Windows module of Mouse Mastery. In this section, you will learn how to navigate the settings, create and save files, and access the internet on your computer.	\N
1	2	\N	\N	\N	To get started, locate the Phone app on your Android device. You can usually find it on your home screen or in the app drawer. Tap the Phone app icon to open it. The main features of the Phone app include the dialer, contacts, and call log.	Android
1	3	\N	\N	\N	To dial a phone number, use the dialer within the Phone app to enter the number manually. Alternatively, you can use the contacts list to select a contact and dial their number. If you need to add an area code or use a pause to dial extensions, you can do so using the dialer.	Android
1	4	\N	\N	\N	To make a call, tap the call button (usually represented by a green phone icon) within the Phone app. This will initiate the call and connect you to the desired phone number. During the conversation, you can adjust the call volume or use the speakerphone option if available.	Android
1	5	\N	\N	\N	To end a call, tap the end call button (usually represented by a red phone icon) within the active call screen. Alternatively, you can use the power button to end the call when the phone is unlocked. If you want to use headphones or a Bluetooth device to end the call during the conversation, you can do so by disconnecting them.	Android
1	6	\N	\N	\N	In this module, you learned how to use your Android device to make phone calls. You learned how to open the Phone app, dial a phone number, make a call, and end a call. Remember to adjust the call volume, use the speakerphone option if needed, and end calls using the appropriate buttons or methods. Practice making phone calls to become more proficient in using this feature on your Android device.	Android
2	1	\N	\N	\N	Welcome to the "Writing Texts" module of Mouse Mastery, where you will learn how to use your Android device to write and send text messages. This module is designed for individuals who are new to using an Android device. By the end of this module, you will be able to open the messaging app, compose a new message, enter recipients' phone numbers or contacts, and send a message.	Android
2	2	\N	\N	\N	To get started, locate the messaging app on your Android device. You can usually find it on your home screen or in the app drawer. Tap the messaging app icon to open it. The main features of the messaging app include the message composition screen, conversation list, and settings.	Android
2	3	\N	\N	\N	To compose a new message, tap the "New Message" or "Compose" button within the messaging app. This will take you to the message composition screen, where you can enter the text of your message.	Android
2	4	\N	\N	\N	To enter recipients' phone numbers or contacts, tap the "To" field within the message composition screen. You can manually enter a phone number or select a contact from your contacts list. If you want to send the message to multiple recipients, separate their phone numbers or contacts with commas.	Android
2	5	\N	\N	\N	To write the message, use the keyboard within the message composition screen to type the text. You can also use emojis, attachments, or other features available in the messaging app. Once the message is ready, tap the send button to send it.	Android
2	6	\N	\N	\N	In this module, you learned how to use your Android device to write and send text messages. You learned how to open the messaging app, compose a new message, enter recipients' phone numbers or contacts, and send the message. Remember to review your message before sending it and explore additional features offered by the messaging app to enhance your texting experience.	Android
3	1	\N	\N	\N	Welcome to the "Connecting to WiFi" module of Mouse Mastery, where you will learn how to connect your Android device to a WiFi network. This module is designed for individuals who want to access the internet or connect to specific WiFi networks. By the end of this module, you will be able to open the device settings, select a WiFi network, enter the password if required, and establish a WiFi connection.	Android
3	2	\N	\N	\N	To get started, locate the Settings app on your Android device. You can usually find it on your home screen or in the app drawer. Tap the Settings app icon to open it. The main features of the Settings app include various system settings for your Android device.	Android
3	3	\N	\N	\N	To open the WiFi settings, scroll down or search for the "WiFi" option within the Settings app. Tap on it to access the WiFi settings screen.	Android
3	4	\N	\N	\N	Within the WiFi settings screen, you will see a list of available WiFi networks. Tap on the network you want to connect to. If the network is secure and requires a password, you will be prompted to enter the password.	Android
3	5	\N	\N	\N	Enter the password for the selected WiFi network using the on-screen keyboard. After entering the password, tap the "Connect" or "Join" button to establish a connection to the selected WiFi network. Your Android device will attempt to connect to the network, and once the connection is established, you will see a notification indicating successful WiFi connectivity.	Android
3	6	\N	\N	\N	In this module, you learned how to connect your Android device to a WiFi network. You learned how to open the WiFi settings, select a network, enter the password if required, and establish a WiFi connection. Remember to choose secure and reliable WiFi networks, enter the correct passwords, and ensure a stable connection for optimal internet access on your Android device.	Android
4	1	\N	\N	\N	Welcome to the "Contacts" module of Mouse Mastery, where you will learn how to manage your contacts on your Android device. This module is designed for individuals who want to save and access contact information easily. By the end of this module, you will be able to open the Contacts app, add new contacts, enter contact details, and save the contacts.	Android
4	2	\N	\N	\N	To get started, locate the Contacts app on your Android device. You can usually find it on your home screen or in the app drawer. Tap the Contacts app icon to open it. The main features of the Contacts app include the contacts list, search function, and contact details.	Android
4	3	\N	\N	\N	To add a new contact, within the Contacts app, look for the "Add" or "New Contact" button. Tap on it to create a new contact entry.	Android
4	4	\N	\N	\N	Within the new contact entry screen, enter the contact details, such as their name, phone number, email address, and any additional information you want to include. You can use the on-screen keyboard to enter the information.	Android
4	5	\N	\N	\N	Once you have entered the contact details, tap the "Save" or "Done" button to save the contact. The contact will now be added to your contacts list.	Android
4	6	\N	\N	\N	In this module, you learned how to manage your contacts on your Android device. You learned how to open the Contacts app, add new contacts, enter contact details, and save the contacts. Remember to regularly update your contacts list and utilize the search function for easy access to contact information.	Android
1	1	\N	\N	\N	In this module, you will learn how to navigate to the Finder application on your Mac. Finder is a file management tool that allows you to access and organize files and folders on your Mac. By the end of this module, you will be able to locate and open the Finder application from the Dock.	macOS
1	2	\N	\N	\N	Bring the mouse to the Dock.	macOS
1	3	\N	\N	\N	Click on the Finder icon (represented by a blue and white smiley face). Shortcut: You can also press Command + Space to open Spotlight search, type "Finder," and press Enter to open the Finder application.	macOS
1	4	\N	\N	\N	This action will bring up the Finder window, which displays your files and folders.	macOS
1	5	\N	\N	\N	To navigate to the Documents folder, click on "Documents" in the left sidebar.	macOS
1	6	\N	\N	\N	In this module, you learned how to navigate to the Finder application from the Dock on your Mac. By clicking on the Finder icon in the Dock or using the Command + Space shortcut, you can open the Finder window, which allows you to manage and organize your files and folders. Additionally, you learned to access the Documents folder, where you can find and work with your documents effectively.	macOS
2	1	\N	\N	\N	In this module, you will learn how to connect your Mac to a WiFi network using the System Preferences. Connecting to WiFi is crucial for accessing the internet and various online services. By the end of this module, you will be able to access the Network settings, select the WiFi network, and sign in to connect to the network	macOS
2	2	\N	\N	\N	Go back to the Dock and click on the System Preferences icon (represented by a gear). Within System Preferences, click on the Network option. You can also choose a network by clicking the WiFi symbol in the top left corner of the screen.	macOS
2	3	\N	\N	\N	From the Network settings, ensure that WiFi is selected as the preferred network connection.	macOS
2	4	\N	\N	\N	To connect to a WiFi network, select the desired network from the list of available networks. If the network is secured, you will be prompted to enter the password. Type in the password and click "Join" to authenticate.	macOS
2	5	\N	\N	\N	Once connected, the WiFi icon in the menu bar at the top of the screen will indicate a successful connection.	macOS
2	6	\N	\N	\N	In this module, you learned how to connect your Mac to a WiFi network using the System Preferences. By accessing the Network settings, selecting the appropriate WiFi network, and entering the password if required, you can establish a connection. The WiFi icon in the menu bar will indicate a successful connection. This allows you to access the internet and enjoy various online services on your Mac.	macOS
3	1	\N	\N	\N	In this module, you will learn how to perform a search on macOS. Searching allows you to quickly find files, applications, settings, and other content on your Mac. By the end of this module, you will be able to access the search function and initiate a search using the magnifying glass icon.	macOS
3	2	\N	\N	\N	Access the search function by clicking on the magnifying glass icon in the top-right corner of the screen (in the menu bar). Shortcut: You can also use the Command + Space shortcut to open Spotlight search.	macOS
3	3	\N	\N	\N	Once the search bar appears, type in your desired search query.	macOS
3	4	\N	\N	\N	As you type, macOS will display search results that match your query.	macOS
3	5	\N	\N	\N	Use the search results to locate and access files, applications, settings, and other items on your Mac.	macOS
3	6	\N	\N	\N	In this module, you learned how to perform searches on your Mac using the search function. By accessing the search bar through the magnifying glass icon in the menu bar or using the Command + Space shortcut, you can quickly search for apps, documents, emails, and other items on your Mac. Additionally, you can open the Safari browser by typing "Safari" in the Spotlight search bar, enabling you to browse the internet and access websites like Google.	macOS
4	1	\N	\N	\N	In this module, you will learn how to open the Safari browser on your Mac and navigate to the Google website. Safari is the default web browser on macOS, and it allows you to browse the internet and search for information. By the end of this module, you will be able to open Safari and access the Google website.	macOS
4	2	\N	\N	\N	Locate the Safari icon in the Dock (blue compass icon) and click on it to open the Safari browser.	macOS
4	3	\N	\N	\N	Locate the Safari icon in the Dock (blue compass icon) and click on it to open the Safari browser.	macOS
4	4	\N	\N	\N	Once Safari is open, click on the address bar at the top of the window.	macOS
4	5	\N	\N	\N	Type "www.google.com" in the address bar and press Enter.	macOS
4	6	\N	\N	\N	Safari will load the Google homepage, where you can search the web, access Gmail, and use other Google services.	macOS
4	7	\N	\N	\N	In this module, you learned how to open the Safari browser on your Mac and navigate to the Google website. By clicking on the Safari icon in the Dock and entering "google.com" in the address bar, you can access the Google homepage. From there, you can perform web searches, access Gmail, and utilize various Google services.	macOS
\.
